...
"""
def generate_np_embed(ctx, song: tuple, bot, embed_theme):
...
"""
def generate_display_queue(ctx, queue, bot, embed_theme, queue_display_length):
...
"""
def generate_invite(ctx, bot, embed_theme, invite_link):
...
"""
def generate_help(ctx, bot, embed_theme, get_prefix):
...
"""
def generate_new_server_embed(guild, bot, embed_theme):
